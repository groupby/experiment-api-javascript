...
const PACKAGE_WHITELIST = {
  ...
  'callsite':       ['^1.0.0'], // Has MIT license https://github.com/tj/callsite/blob/master/LICENSE
  'indexof':        ['^0.0.1'], // Has MIT license https://github.com/component/indexof/blob/master/LICENSE
  'ripemd160':      ['^0.2.0']  // Has MIT license https://github.com/crypto-browserify/ripemd160/blob/master/LICENSE.md
};
